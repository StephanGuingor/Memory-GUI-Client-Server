...
from code.pyIgnitionAlpha import particles, gravity
import sys, pygame
...
class ParticleEffect:
	...
	def CreateSource(self, pos = (0, 0), initspeed = 0.0, initdirection = 0.0, initspeedrandrange = 0.0, initdirectionrandrange = 0.0, particlesperframe = 0, particlelife = 0, drawtype = 0, colour = (0, 0, 0), radius = 0.0, length = 0.0, image = None):
		newsource = particles.ParticleSource(self, pos, initspeed, initdirection, initspeedrandrange, initdirectionrandrange, particlesperframe, particlelife, drawtype, colour, radius, length, image)
...
if __name__ == '__main__':
	...
	testsource = test.CreateSource((10, 10), 5.0, 2.35619449, 2.0, 1.0, 5, 500, DRAWTYPE_SCALELINE, (255, 255, 255), length = 10.0)
